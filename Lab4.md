...
```{r}
air_quality<-read.csv("C:/Users/507-3/Desktop/hw1_data.csv",header = TRUE, sep=",",)
...
data1<-subset (air_quality, Ozone>31&Temp>90)
...
mean (subset (air_quality, Month==6)$Temp)
[1] 79.1

#Task9
#Яке максимальне значення «Ozone» для травня («Month» дорівнює 5)?
max(subset(air_quality, Month==5)$Ozone, na.rm=TRUE)
[1] 115
